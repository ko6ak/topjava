...
//        System.out.println("--------------------");
//        System.out.println(mealRestController.create(new Meal(5, LocalDateTime.now(), "desc", 3000)));
//        System.out.println(mealRestController.getAll());
//        System.out.println("--------------------");
//        mealRestController.update(new Meal(1, LocalDateTime.now(), "dsljkfhgh", 800), 4);
//        System.out.println(mealRestController.getAll());
//        System.out.println("--------------------");
